...
const countryImages: Record<Country, string> = {
    Australia: '/mapQuest_images/Countries/Oceania/Australia.png',
    'New Zealand': '/mapQuest_images/Countries/Oceania/New Zealand.png'
};
...
const NorthAmericaMapGame: React.FC = () => {
  const countries: Country[] = ["Australia", "New Zealand"];
